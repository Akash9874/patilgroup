        ...
        <div className={`mb-6 transition-opacity duration-600 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
          {currentVariant.mainTitle.map((line, index) => (
            <h2 
              ...
              className="text-[#F2913F] font-extrabold text-5xl sm:text-6xl leading-[0.9] tracking-tight mb-1 mobile-hero-text mobile-heading drop-shadow-lg"
            >
              {line}
            </h2>
          ))}
        ...
        <div className={`space-y-1 transition-opacity duration-600 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
          {currentVariant.subtitle.map((line, index) => (
            <h1 
              ...
              className="text-white font-semibold text-2xl leading-tight mobile-hero-text mobile-smooth drop-shadow-lg"
            >
              {line}
            </h1>
          ))}
