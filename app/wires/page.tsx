  ...
  return (
    <div className="bg-black text-white">
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="grid grid-cols-2 gap-8">
              ...
              <div className="border-r border-gray-700 px-8">
            ...
            <div className="text-right flex flex-col justify-between">
              <h2 className="text-5xl font-bold">
                ...
                <span className="text-[#F2913F]">across </span><span className="text-[#8A393B]">three</span><br/>
      ...
      <div className="bg-white text-black py-16">
        <div className="max-w-7xl mx-auto px-8">
          <h2 className="text-5xl font-bold text-[#F2913F] mb-12">Product Types</h2>
          <div className="space-y-8">
            <div className="grid md:grid-cols-2 gap-8 items-center border-t border-gray-200 pt-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-start border-t border-gray-200 pt-8">
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="relative">
              <Image src="/engineering-infra.jpg" alt="Steel wire products" width={500} height={300} className="rounded-lg" />
            </div>
            <div className="bg-white p-8 rounded-lg shadow-lg -ml-16">
