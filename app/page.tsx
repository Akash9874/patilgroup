            ...
            <div className="fade-in-section">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#8A393B] leading-tight mb-4">
                  More than <span className="text-[#F2913F]">100 million sleepers</span> in service for the last 30 years, <span className="text-[#F2913F]">makes us the world's largest<br />manufacturer.</span>
                </h2>
              </div>
            </div>
