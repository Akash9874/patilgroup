        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 md:gap-10 mb-6 sm:mb-8 md:mb-12 max-w-5xl w-full">
            ...
            <div className="flex flex-col items-center">
              <div className="text-[#F2913F] text-4xl sm:text-5xl md:text-6xl font-bold mb-1 sm:mb-2">50+</div>
              <div className="text-[#F2913F] text-sm sm:text-base md:text-lg font-medium">years on the job</div>
            </div>

            {/* Stat 2 */}
            <div className="flex flex-col items-center border-l border-r border-white/30 px-3 sm:px-4">
              <div className="text-[#F2913F] text-2xl sm:text-3xl md:text-4xl font-bold mb-2">Uncompromising</div>
              <div className="text-[#F2913F] text-2xl sm:text-3xl md:text-4xl font-bold">Quality Standards</div>
          </div>

            {/* Stat 3 */}
            <div className="flex flex-col items-center">
              <div className="text-[#F2913F] text-4xl sm:text-5xl md:text-6xl font-bold mb-1 sm:mb-2">4,00,000+</div>
