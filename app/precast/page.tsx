    ...
    <div className="bg-white text-black">
      ...
      <section className="bg-white text-black py-8 sm:py-12 md:py-20 fade-in-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
          <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#8A393B] mb-8 sm:mb-10 md:mb-14">Product Portfolio</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12">
            ...
            <div>
              <h4 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-amber-500">U Drains</h4>
                <p className="mt-3 sm:mt-4 text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl max-w-4xl leading-relaxed">
            ...
            <div className="flex justify-center items-start lg:sticky lg:top-4 lg:h-screen lg:overflow-hidden mt-8 lg:mt-0">
