    ...
    <>
      <section className="relative h-screen bg-black flex items-center justify-center">
        ...
        <div className="relative z-10 text-center">
          <h1 className="text-8xl font-bold text-white animate-fadeInUp">
            Careers
          </h1>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <h2 className="text-6xl font-bold text-[#8A393B]">Join our team</h2>
              <p className="mt-2 text-4xl text-orange-400">Build the future of rail</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 border-t border-gray-300">
            <div className="pt-8 pr-8">
              <h2 className="text-4xl font-bold text-[#8A393B]">We hire for roles across</h2>
